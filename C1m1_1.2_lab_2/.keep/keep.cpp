...
// // [INCLUDES PROGRESS BAR & TABLE IDEA] Keeping some other parts of lab 4 here
...
// // #include "header1.h"  // For date
// // #include "header2.h"  // For random
...
//     cout << left << setw(15) << "float" << right << setw(20) << sizeof(float) << left << setw(20) << "  smaller integer" << endl;
//     cout << left << setw(15) << "short" << right << setw(20) << sizeof(short) << left << setw(20) << "  4 to 8 bytes" << endl;
